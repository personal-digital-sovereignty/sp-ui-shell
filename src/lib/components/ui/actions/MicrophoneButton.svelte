...
<div class="relative flex items-center">
	{#if isRecording}
		<div
			...
			class="absolute -top-10 left-1/2 -translate-x-1/2 bg-rose-500 text-white text-[10px] font-bold px-2 py-1 rounded shadow-lg flex items-center gap-1.5 whitespace-nowrap"
		>
	...
	<button
		...
		class="p-2.5 rounded-lg transition-colors cursor-pointer disabled:opacity-50 flex items-center gap-2 group {isRecording
			? 'text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10'
			: 'text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-[#1d253b]'}"
