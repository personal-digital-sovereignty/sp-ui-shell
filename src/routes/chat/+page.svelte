...
<div class="flex flex-col h-full w-full bg-[#F4F7FA] dark:bg-[#080e1d] font-sans">
	<header class="mb-6 px-4 md:px-10 pt-10 w-full flex items-center shrink-0">
		<h1
			class="font-extrabold text-xl md:text-2xl text-[#191c1d] dark:text-slate-200 tracking-tight flex items-center gap-3"
		>
			<button
				onclick={() => (isHistoryOpen = !isHistoryOpen)}
				class="p-1.5 -ml-1.5 hover:bg-slate-200/50 dark:hover:bg-[#1d253b] rounded-lg transition-colors cursor-pointer text-primary dark:text-[#74b0ff]"
